...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "WorldClock.controller.Offices": [],
  "WorldClock.model.Clock": [],
  "WorldClock.model.ClosedHours": [],
  "WorldClock.model.FontSizes": [],
  "WorldClock.model.OpenHours": [],
  "WorldClock.model.Options": [],
  "WorldClock.model.TimeZone": [],
  "WorldClock.store.Clocks": [],
  "WorldClock.store.ClosedHours": [],
  "WorldClock.store.FontSizes": [],
  "WorldClock.store.OpenHours": [],
  "WorldClock.store.Options": [],
  "WorldClock.store.TimeZones": [],
  "WorldClock.view.AddOffice": [],
  "WorldClock.view.Clocks": [],
  "WorldClock.view.Office": [],
  "WorldClock.view.Options": [],
  "WorldClock.view.UpdateOffice": [],
  "WorldClock.view.Viewport": []
});
